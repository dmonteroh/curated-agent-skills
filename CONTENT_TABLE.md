...
| `google-stitch-ai` | (Stitch) Create DESIGN.md from Stitch projects and enhance Stitch prompts. Supports MCP server retrieval or offline HTML/screenshots. Use for Stitch-compatible design system synthesis or prompt polishing. |
