...
- `compliance-governance.md` - Regulatory frameworks, governance, audit evidence.
- `monitoring-incident.md` - Monitoring, detection, incident response practices.
- `emerging-and-knowledge.md` - Emerging technologies, behavioral traits, knowledge base.
- `backend-security-coding.md` - Condensed backend security checklist.
- `compliance-checklist.md` - Condensed compliance checklist.
- `security-scanning.md` - Condensed scanning expectations and outputs.
