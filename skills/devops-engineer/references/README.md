# DevOps Engineer References

Short, scoped reference material for runtime operations and reliability work.
...
- `deployment-metrics-canary.md` - DORA metrics and automated canary guidance.
- `platform-engineering.md` - Index for platform engineering references.
- `platform-principles-self-service.md` - Principles and self-service examples.
- `platform-templates-gitops.md` - Templates, GitOps layout, and ArgoCD setup.
- `platform-ops-apis.md` - Platform APIs, plugins, CLI, and multi-tenant patterns.
- `platform-metrics-adoption.md` - Metrics, adoption goals, and best practices.
- `incident-response.md` - Index for incident response references.
- `incident-response-metrics-severity.md` - Response metrics and severity matrix.
- `incident-response-runbook-postmortem.md` - Runbook and postmortem templates.
