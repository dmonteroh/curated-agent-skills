...
- `tool-design.md`: Checklist for workflow-first tool design and scope control.
...
- `provider-contracts.md`: Optional-capability provider contract — required/optional ops, typed unsupported errors, consent axes, provider-off behavior.
