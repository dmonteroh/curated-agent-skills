...
## Setup: tiktoken in .venv

The review runner expects `tiktoken` to be available via a local virtual environment at:
...
- Token measurement uses `tiktoken` and is executed via the repo venv to keep tooling consistent.
