...
```bash
npx add-skill google-labs-code/stitch-skills --skill stitch-enhance-prompt --global
```
...
Note: This skill does not require the Stitch MCP server. It can enhance prompts using only local files (e.g., DESIGN.md) and the user’s input.
