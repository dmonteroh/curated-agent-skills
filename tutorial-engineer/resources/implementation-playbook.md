...
- Quickstart (5-15 minutes): setup + first successful run.
- Guided build (30-90 minutes): step-by-step feature implementation.
- Deep dive (60-180 minutes): explains tradeoffs + multiple approaches.
- Workshop series (multi-part): staged learning objectives + exercises.
