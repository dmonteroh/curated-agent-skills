...
description: Plan and execute ORM-managed database migrations (Prisma/TypeORM/Sequelize/EF) with zero-downtime strategies, data transformation, and rollback procedures. Use only for ORM migration tooling/workflows (not raw SQL migration file workflows).
---
...
Note: this skill is intentionally **ORM-oriented** and should not be used for raw SQL migration-file workflows.
